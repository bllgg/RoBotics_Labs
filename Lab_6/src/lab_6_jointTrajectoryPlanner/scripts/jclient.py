...
if __name__ == "__main__":
    ...
    joint_space = [[0.0, 0.0, 0.0, 0.0, 5.0], [-0.2, 0.0, 0.0, 0.0, 5.0], [-0.2, 0.4, 0.0, 0.0, 5.0], [0.2, -0.2, -0.4, 0.0, 5.0], [-0.4, 0.2, 0.2, 0.2, 5.0]]
    ...
    for joint in joint_space :
        ...
        if move_in_joint_space(joint[0], joint[1], joint[2], joint[3], joint[4]):
    ...
    # if move_in_joint_space(joint_space[itr][0], joint_space[itr][1], joint_space[itr][2], joint_space[itr][3], joint_space[itr][4]):
    #     print("Successfully moved")
    # else:
    #     print("Failed to move")
